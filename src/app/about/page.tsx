...
export const metadata: Metadata = {
  title: "About Us",
  description:
    "Regis and Savoy Corporate Services LLP — trusted advisors for every stage of your business journey.",
};
  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden bg-paper-3 py-28">
        <Botanical src="green.png" className="right-[4vw] top-12 hidden w-16 sm:block md:w-24" />
            ...
            {about.whyChoose.map((v, i) => (
              <StaggerItem key={v.title}>
                <div className="group h-full bg-paper-2 p-8 transition-colors duration-500 hover:bg-night">
                  ...
                  <h3 className="mt-6 font-[var(--font-display)] text-2xl leading-snug text-ink transition-colors duration-500 group-hover:text-paper">
                    {v.title}
                  </h3>
